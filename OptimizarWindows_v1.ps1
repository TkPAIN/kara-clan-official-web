...
Write-Host "[$((++$c))/8] Nagle OFF..." -ForegroundColor Yellow
...
Write-Host "[$((++$c))/8] High Performance Power Plan..." -ForegroundColor Yellow
powercfg -setactive 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 2>$null
Write-Host "  [OK] Activated" -ForegroundColor Green

Write-Host "[$((++$c))/8] Cloudflare DNS..." -ForegroundColor Yellow
...
Write-Host "[$((++$c))/8] Flush DNS cache..." -ForegroundColor Yellow
ipconfig /flushdns | Out-Null
Write-Host "  [OK] Flushed" -ForegroundColor Green

Write-Host "[$((++$c))/8] Delivery Optimization OFF..." -ForegroundColor Yellow
...
Write-Host "[$((++$c))/8] Bandwidth limit 1 Mbps..." -ForegroundColor Yellow
...
Write-Host "[$((++$c))/8] Telemetry OFF..." -ForegroundColor Yellow
...
Write-Host "[$((++$c))/8] Background Apps OFF..." -ForegroundColor Yellow
